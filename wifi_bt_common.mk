...
ifeq ($(strip $(BOARD_CONNECTIVITY_VENDOR)), NFORETEK)
...
ifneq (,$(filter  car vehicle, $(TARGET_BOARD_PLATFORM_PRODUCT)))
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/rockchip/rk3588/rk3588m_car/bluetooth
endif
